...
async function loader4({ request, params }) {
  const { data: category } = await supabaseAdmin.from("categories").select().match({ id: params.categoryID }).limit(1).single();
  const { data: transactions, error } = await supabaseAdmin.from("vw_transactions").select().match({ category_id: params.categoryID });
...
function Transactions() {
  ...
  let { updateSuccess, insertSuccess, error, errors } = (0, import_react9.useActionData)() || {};
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "Transactions for ", category.name), /* @__PURE__ */ React.createElement(import_react10.Form, {
  ...
  }), (errors == null ? void 0 : errors.transaction_date) && /* @__PURE__ */ React.createElement("span", {
    id: "errorTransaction_date"
  }, errors == null ? void 0 : errors.transaction_date), /* @__PURE__ */ React.createElement("label", {
    htmlFor: "amount"
  ...
  }), (errors == null ? void 0 : errors.amount) && /* @__PURE__ */ React.createElement("span", {
    id: "errorAmount"
  }, errors == null ? void 0 : errors.amount), /* @__PURE__ */ React.createElement("button", {
    type: "submit",
    name: "_action",
    value: "insert",
    ...
    role: "alert"
  }, "An error occurred. Please check your data and try again."), insertSuccess && transition.state === "idle" && /* @__PURE__ */ React.createElement("div", {
    role: "alert"
    ...
    scope: "col"
  }, "Delete"))), /* @__PURE__ */ React.createElement("tbody", null, trs)), updateSuccess && transition.state === "idle" && /* @__PURE__ */ React.createElement("div", {
    role: "alert"
  }, "Transaction updated Successfully."), forms);
}
...
async function action4({ request, params }) {
  return authenticated(request, async (user) => {
    ...
    supabaseAdmin.auth.setAuth(await getAccessToken(request));
    if (_action === "delete") {
      return (0, import_node8.redirect)(`/categories/delete/${id}/${params.budgetID}`);
    }
    if (_action === "insert") {
...
var loader6 = async ({ request, params }) => {
  ...
  if (!data || (data == null ? void 0 : data.length) === 0) {
    return (0, import_node9.json)({ id: -1, month, year, income: 0, user_id: "" });
  } else {
...
function Budget() {
  ...
  (0, import_react15.useEffect)(() => {
    var _a2, _b2;
    if (((_b2 = (_a2 = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _a2.fieldErrors) == null ? void 0 : _b2.income) !== void 0) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h1", {
    ...
    id: "incomeError"
  }, (_b = (_a = actionData == null ? void 0 : actionData.errors) == null ? void 0 : _a.fieldErrors) == null ? void 0 : _b.income), /* @__PURE__ */ React.createElement("button", {
    type: "submit",
    name: "_action",
    disabled: transition.state !== "idle",
    "aria-live": "polite",
